We'd love you to contribute to Octopin!

## Issues

Questions, feature requests and bug reports are all welcome as [discussions or issues](https://github.com/eclipse-csi/octopin/issues/new/choose).
...
["help wanted"](https://github.com/eclipse-csi/octopin/labels/help%20wanted) label on GitHub.

To make contributing as easy and fast as possible, you'll want to run tests and linting locally. Luckily,
Octopin has few dependencies, doesn't require compiling and tests don't need access to databases, etc.
...
git clone https://github.com/<your username>/octopin.git
cd octopin
