...
* chore(deps): bump pypa/gh-action-pypi-publish from 1.12.4 to 1.13.0. PR [#58](https://github.com/eclipse-csi/octopin/pull/58) by [@dependabot[bot]](https://github.com/apps/dependabot).
